...
| D4 | Differentiator ordering | Not yet consumed by this build (commercial-material concern, artefact 02 — Fable 5's remit, not ecos-app's). Noted here for traceability only. |
