/**
 * Election-COS1.0 — static Tailwind class lookup for sentiment tones
 *
 ...
 * once, keyed by the same tone names as sentiment.ts's SENTIMENT_META.
 */
type Tone = 'maroon' | 'gold' | 'slate' | 'teal' | 'green';
...
/** Lighter pill treatment — sentiment badges on the voter list/card, not the active picker state. */
