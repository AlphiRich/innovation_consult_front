 ...
 *
 * SOP-01 through SOP-04 are written. The rest are declared as the manual's
...
export const SOPS: Sop[] = [CANVASSER_SOP, TENANT_SETUP_SOP, WARD_SEEDING_SOP, REGISTER_IMPORT_SOP];
